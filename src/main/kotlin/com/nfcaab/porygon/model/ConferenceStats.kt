...
@Entity
@Table(name = "conference_stats", schema = "porygon")
class ConferenceStats(
    ...
    // Batting Stats (Conference Totals)
    @Basic
    @Column(name = "at_bats")
    var atBats: Int = 0,
    @Basic
    ...
    // Pitching Stats (Conference Totals)
    @Basic
    ...
    // Game Control (Conference Totals)
    @Basic
    ...
    // Opponent Stats (Conference Totals)
    @Basic
