...
import com.nfcaab.porygon.dto.response.GameSpreadResult
import com.nfcaab.porygon.dto.response.UpdateSpreadsResponse
import com.nfcaab.porygon.dto.response.VegasOddsResponse
    ...
    fun updateSpreadsForSeasonAndWeek(
        ...
        return try {
            ...
            for (game in games) {
                ...
                val spread = calculateVegasSpread(homeStats.teamElo ?: 1500.0, awayStats.teamElo ?: 1500.0)
                ...
                results.add(
                    GameSpreadResult(
                        ...
                        homeElo = homeStats.teamElo ?: 1500.0,
                        awayElo = awayStats.teamElo ?: 1500.0,
                        homeSpread = homeSpread,
                        awaySpread = awaySpread,
                    ),
                )
                ...
                logger.info(
                    "Calculated spreads for game ${game.id}: ${game.homeTeam} (${homeStats.teamElo?.toInt() ?: 1500}) " +
                        "vs ${game.awayTeam} (${awayStats.teamElo?.toInt() ?: 1500}) - Home: $homeSpread, Away: $awaySpread",
                )
            }
