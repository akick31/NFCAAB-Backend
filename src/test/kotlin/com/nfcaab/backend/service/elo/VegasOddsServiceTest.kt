...
class VegasOddsServiceTest {
    ...
    fun `updateSpreadsForSeasonAndWeek should update spreads for all games`() {
        ...
        val homeGameStats = GameStats()
        homeGameStats.gameId = 1
        homeGameStats.team = "Home Team"
        homeGameStats.week = 1
        val awayGameStats = GameStats()
        awayGameStats.gameId = 1
        awayGameStats.team = "Away Team"
        awayGameStats.week = 1
        val gameStats = listOf(homeGameStats, awayGameStats)
